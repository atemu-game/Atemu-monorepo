...
import { MintCardProcessor } from './processors/mintCard.proccesor';
...
@Module({
  ...
  providers: [Web3Service, UserPointService, CardService, MintCardProcessor],
})
export class MintCardQueueModule {}
